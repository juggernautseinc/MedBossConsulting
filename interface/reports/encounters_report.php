  ...
  <td style="width: 650px">
   ...
   <td>
       <script>
           ...
           ?>
               EncounterIdArray[<?php echo attr($row['pid']); ?>][Count] = <?php echo js_escape($rowresult4['encounter']); ?>;
               EncounterDateArray[<?php echo attr($row['pid']); ?>][Count] = <?php echo js_escape(oeFormatShortDate(date("Y-m-d", strtotime($rowresult4['date'])))); ?>;
               CalendarCategoryArray[<?php echo attr($row['pid']); ?>][Count] = <?php echo js_escape(xl_appt_category($rowresult4['pc_catname'])); ?>;
               EncounterNoteArray[<?php echo attr($row['pid']); ?>][Count] = <?php echo js_escape($rowresult4['billing_note']); ?>;
               Count++;
           <?php
