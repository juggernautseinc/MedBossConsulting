      ...
      <div class="<?php echo $loginrow; ?>">
          ...
          <div class="<?php echo $logoarea; ?>">
            ...
            <div class="text-center">
              <span class="d-inline-block w-40"><?php  if ($_SESSION['site_id'] == 'default') { echo file_get_contents($GLOBALS['images_static_absolute'] . "/login-logo.png"); } ?></span>
            ...
            <?php } else { ?>
              <div class="mx-auto m-4 w-75">
                  ...
                  <img src="../../public/images/medbosslogo.png">
                  <?php } ?>
            ...
            <div class="text-center login-title-label">
                ...
                <?php } ?>
            <p class="text-center lead font-weight-normal login-bg-text-color"><?php echo xlt('Practice Ease is a Med Boss system. We have brought to you a system that lets you focus on patients'); ?></p>
            ...
            <p class="text-center small">Information obtained through any media through MedBOSS Consulting and any of its affiliates is CONFIDENTIAL.   Information obtained should only be on a need to know basis and should be kept confidential.   Access is for authorized personnel only and prior authorization should be obtained before accessing or retrieving any information.   Medical information is privileged and is protected by state and federal statutes.   Any violation of confidentiality may result in punitive action including termination of privileges, employment etc.   By signing on to this device, you agree to abide by the confidentiality agreement.  There is an audit trail of log-ons and of information accessed and there is a routine, random audit performed.  By signing in you agree to ensure your computer is protected and out of view of unauthorized individuals and that your login information is protected not shared with others.</p>
          </div>
      </div>
