      ...
      <div class="<?php echo $loginrow; ?>">
          ...
          <div class="<?php echo $logoarea; ?>">
              ...
              <div class="mx-auto m-4 w-75 text-center">
				 ...
				 <?php } elseif ($_SESSION['site_id'] == 'reencuentro') { ?>
                      <span style="text-align: center">
                          <img src="../../public/images/logo_reencu.png" style="width:80%"></span>
                  <?php } ?>
            ...
            <div class="text-center login-title-label">
              ...
              <p style="text-align: center; font-size: medium; font-weight: bold">A leader in self-managed and managed Practice Management Systems. </p><p style="font-size: x-large; font-weight: bolder; text-align: center">The Choice is Yours.</p>
              <?php } ?>
            <!-- <p class="text-center small"><a href="../../acknowledge_license_cert.html" class="login-bg-text-color" target="main"><?php //echo xlt('Acknowledgments, Licensing and Certification'); ?></a></p> -->
              <p class="text-align-left: font-weight: bold"><br>Information obtained through any media belonging to Med BOSS Consulting and any of its affiliates is CONFIDENTIAL.  Access is for authorized personnel only and prior authorization is required before accessing or retrieving any information. Medical information is privileged and is protected by state and federal statutes. Any violation of confidentiality may result in punitive action including termination of privileges, employment etc. There is an audit trail of information accessed with routine, random audits performed. By signing on to this device, you agree to abide by the confidentiality agreement as stated on our website <a href=\\"http://www.medbossconsulting.com\\"><B>HERE</B></a> and to ensure your computer is protected and out of view of unauthorized individuals and that your login is not shared with others.</p>
