...
<div class="jumbotron jumbotron-fluid px-3 py-4 my-2">
    <div class="form-row mb-sm-2">
        ...
        <?php endif ?>
        <label class='col-sm col-form-label' id='tdallday4'><?php echo xlt('duration') . attr($provider_duration['provider_duration']); ?></label>
        <input class="col-sm form-control" id='tdallday5' type='text' size='4' name='form_duration' value='<?php echo attr($provider_duration['provider_duration']) //attr($thisduration) ?>' title='<?php echo xla('Event duration in minutes'); ?>' />
    </div>
    <div class="form-row mb-sm-2">
...
<div class="form-row mx-2 mt-3">
    ...
    <?php } ?>
    <?php if (AclMain::aclCheckCore('admin', 'super') || AclMain::aclCheckCore('patients', 'appt')) { ?>
