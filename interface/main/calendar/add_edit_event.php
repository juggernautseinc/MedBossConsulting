...
<div class="jumbotron jumbotron-fluid px-3 py-4 my-2">
    <div class="form-row mb-sm-2">
        ...
        <input class="col-sm form-control" id='tdallday5' type='text' size='4' name='form_duration' value='<?php echo $provider_duration['provider_duration'] //attr($thisduration) ?>' title='<?php echo xla('Event duration in minutes'); ?>' />
    </div>
    <div class="form-row mb-sm-2">
