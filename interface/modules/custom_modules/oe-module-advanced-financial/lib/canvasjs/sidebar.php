			...
			<ul class="nav nav-sidebar">
					...
					<li>
						<ul id="chart-types" class="sub-menu collapse">
							...
							<li><a href="../canvasjs/chart-types/candlestick.php">Candlestick Chart</a></li>-->
						</ul>
					</li>
					<!-- /chart types -->
					...
					<li>
						<ul id="features" class="sub-menu collapse">
                                                    <li><a href="../canvasjs/features/zooming-panning.php">Zooming &amp; Panning</a></li>
							<li><a href="../canvasjs/features/export-chart.php">Export Chart as Image</a></li>
							<li><a href="../canvasjs/features/event-handling.php">Event Handling</a></li>
							<li><a href="../canvasjs/features/logarithmic-axis.php">Logarithmic Axis</a></li>
							<li><a href="../canvasjs/features/date-time.php">Date-Time Axis</a></li>
							<li><a href="../canvasjs/features/reversed-axis.php">Reverse Axis</a></li>
							<li><a href="../canvasjs/features/strip-line.php">StripLines</a></li>
							<li><a href="../canvasjs/features/multiple-y-axis.php">Multiple Y Axis</a></li>
							<li><a href="../canvasjs/features/multi-series.php">Multiseries Chart</a></li>
						</ul>
					</li>
					<!--  /features -->
