...
<body>
    <div class="container m-5">
        ...
        <a href="../public/invoices?foo=bar" ><?php echo xlt('Invoices Page Go!'); ?></a>
        <a href="../public/home" ><?php echo xlt('Home Page Go!'); ?></a>
        <a href="../public/invoices/create" ><?php echo xlt('Create Invoices Page Go!'); ?>
