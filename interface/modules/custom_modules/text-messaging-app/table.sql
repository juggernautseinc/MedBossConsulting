...
INSERT INTO `background_services` (`name`, `title`, `active`, `running`, `next_run`, `execute_interval`, `function`, `require_once`, `sort_order`) VALUES
    ('SMS_REMINDERS', 'SMS Appointment Reminders', 1, 0, '2022-01-18 08:25:00', 1440, 'start_sms_reminders', '/interface/modules/custom_modules/text-messaging-app/lib/sms_appointment.php', 100);
