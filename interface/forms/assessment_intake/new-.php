...
<div id="container_div" class="container">
    <form method="post" action="<?php echo $rootdir;?>/forms/assessment_intake/save.php?mode=new" name="my_form">
        ...
        <div >
            <input type="checkbox"  name='new_client_eval' />
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" cols="100" rows="3" wrap="virtual" name="school_work"></textarea><br>
            ...
            <h4 class="title text-center"> TREATMENT RECOMMENDATIONS / INITIAL TREATMENT PLAN</h4>
