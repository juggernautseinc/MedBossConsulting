<?php
    ...
    if ($erow['form_id'] > '0') {
        //echo $query ."\nand ".$pid, $encounter_date, $form_folder, $encounter;die();
    ...
    //echo "ok";var_dump($appt);die();
    $values = [];
    $values['encounter'] = $encounter; //$encounter_data['encounter'];
    $values['provider_id'] = $provider_id;
    $newid = formSubmit($table_name, $values, $id, $provider_id);
    addForm($encounter, "TeleHealth Visit", $newid, "telemed", $pid, $user);
