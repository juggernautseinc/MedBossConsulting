    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-12">
                ...
                <form name="soap" id="soap" method="post" action="<?php echo $this->_tpl_vars['FORM_ACTION']; ?>
...
" />
                    ...
                    <fieldset>
                        <div class="container">
                            <div class="form-group">
                                <label for="cpt"><?php echo smarty_function_xlt(array('t' => 'CPT'), $this);?>
</label>
                                <textarea type="text" id="cpt" name="cpt" size="90" class="form-control" onclick="sel_code()" readonly></textarea>
                            </div>
                            <div class="form-group">
                                <label for="dxcode"><?php echo smarty_function_xlt(array('t' => 'Dx'), $this);?>
: </label>
