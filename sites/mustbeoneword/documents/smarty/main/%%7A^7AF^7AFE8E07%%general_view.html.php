<?php /* Smarty version 2.6.31, created on 2021-04-16 20:13:48
         compiled from /var/www/html/boss/templates/documents/general_view.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'dispatchPatientDocumentEvent', '/var/www/html/boss/templates/documents/general_view.html', 15, false),array('function', 'xlj', '/var/www/html/boss/templates/documents/general_view.html', 40, false),array('function', 'xlt', '/var/www/html/boss/templates/documents/general_view.html', 130, false),array('function', 'xla', '/var/www/html/boss/templates/documents/general_view.html', 138, false),array('function', 'user_info', '/var/www/html/boss/templates/documents/general_view.html', 252, false),array('modifier', 'js_url', '/var/www/html/boss/templates/documents/general_view.html', 28, false),array('modifier', 'js_escape', '/var/www/html/boss/templates/documents/general_view.html', 35, false),array('modifier', 'text', '/var/www/html/boss/templates/documents/general_view.html', 128, false),array('modifier', 'attr', '/var/www/html/boss/templates/documents/general_view.html', 139, false),array('modifier', 'attr_js', '/var/www/html/boss/templates/documents/general_view.html', 140, false),array('modifier', 'attr_url', '/var/www/html/boss/templates/documents/general_view.html', 194, false),)), $this); ?>

<script>
 <?php if (! empty ( $this->_tpl_vars['GLOBALS']['oefax_enable'] )): ?>
...
" onclick="top.restoreSession()"><?php echo smarty_function_xlt(array('t' => 'Download'), $this);?>
            ...
            <a class="btn btn-primary" href='javascript:' onclick='return import_ccr(<?php echo ((is_array($_tmp=$this->_tpl_vars['file']->get_id())) ? $this->_run_mod_handler('attr_js', true, $_tmp) : attr_js($_tmp)); ?>
)'><?php echo smarty_function_xlt(array('t' => 'Import'), $this);?>
</a>
            <?php endif; ?>
            </span>
            </h4>
...
" onsubmit="return top.restoreSession()">
          <p class="lead font-weight-bold"><?php echo smarty_function_xlt(array('t' => 'Encryption'), $this);?>
</p>
          <div class="form-group">
            <label for='passphrase'><?php echo smarty_function_xlt(array('t' => 'Pass Phrase'), $this);?>
:</label>
...
" type='text' size='20' name='passphrase' id='passphrase' value='' />
          ...
          <a href="javascript:;" class="btn btn-primary btn-sm" onclick="submitNonEmpty( document.forms['document_encrypt'] );"><?php echo smarty_function_xlt(array('t' => 'download encrypted file'), $this);?>
</a>
        </form>
      </div>
      <?php endif; ?>
...
" onsubmit="return top.restoreSession()">
          <p class="font-weight-bold"><?php echo ((is_array($_tmp=$this->_tpl_vars['file']->get_hash_algo_title())) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
 <?php echo smarty_function_xlt(array('t' => 'Hash'), $this);?>
:</p>
          <p<i><?php echo ((is_array($_tmp=$this->_tpl_vars['file']->get_hash())) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
</i></p>
...
" onsubmit="return top.restoreSession()">
          <div class="form-inline">
            <select class="form-control" name="new_category_id"><?php echo $this->_tpl_vars['tree_html_listbox']; ?>
</select>&nbsp;
            <?php echo smarty_function_xlt(array('t' => 'Move to Patient'), $this);?>
 # <input type="text" class="form-control" name="new_patient_id" size="4" />
...
/stock_search-16.png" /></a>
              <input type="hidden" name="new_patient_name" value="" />
          </div>
          <button class="btn btn-primary btn-sm mt-2" onclick="document.forms['document_move'].submit();"><?php echo smarty_function_xlt(array('t' => 'Move'), $this);?>
</button>
        </form>
      </div>
			<div class="mb-2">
...
" onsubmit="return top.restoreSession()">
          <p class="font-weight-bold"><?php echo smarty_function_xlt(array('t' => 'Tag to Encounter'), $this);?>
</p>
          <div class="form-inline">
...
" class="btn btn-danger hide_clear"><?php echo smarty_function_xlt(array('t' => 'clear'), $this);?>
            ...
            <input type="checkbox" name="encounter_check" id="encounter_check" onclick='set_checkbox(this)'/> <label for="encounter_check" class="font-weight-bold"><?php echo smarty_function_xlt(array('t' => 'Create Encounter'), $this);?>
</label>&nbsp;&nbsp;
            <?php echo smarty_function_xlt(array('t' => 'Visit Category'), $this);?>
: &nbsp;<select class="form-control" id="visit_category_id" name="visit_category_id"  disabled><?php echo $this->_tpl_vars['VISIT_CATEGORY_LIST']; ?>
</select>&nbsp;
          </div>
          <button class="btn btn-primary btn-sm mt-2" onclick="tagUpdate();"><?php echo smarty_function_xlt(array('t' => 'submit'), $this);?>
</button>
        </form>
      </div>
      <div class="mb-2">
...
" onsubmit="return top.restoreSession()">
          ...
          <p class="font-weight-bold"><?php echo smarty_function_xlt(array('t' => 'Tag to Image Procedure'), $this);?>
</p>
          <div class="form-group">
            <select class="form-control" id="image_procedure_id"  name="image_procedure_id"><?php echo $this->_tpl_vars['IMAGE_PROCEDURE_LIST']; ?>
</select>&nbsp;
          </div>
          <div class="btn-group">
            <a class="btn btn-primary btn-sm" href="javascript:;" onclick="ImgProcedure();"><?php echo smarty_function_xlt(array('t' => 'submit'), $this);?>
</a>
        ...
        <div class="text">
          <div>
            ...
            <div class="float-none form-inline">
              <a class="btn btn-primary" href="javascript:;" onclick="document.notes.identifier.value='no';document.forms['notes'].submit();">(<?php echo smarty_function_xlt(array('t' => 'add'), $this);?>
)</a>
              ...
              <a class="btn btn-primary" href="javascript:;" onclick="javascript:document.notes.identifier.value='yes';document.forms['notes'].submit();">(<?php echo smarty_function_xlt(array('t' => 'Send'), $this);?>
)</a>
            </div>
            <div>
