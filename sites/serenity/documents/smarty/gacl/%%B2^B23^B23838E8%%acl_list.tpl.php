...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'attr', 'phpgacl/acl_list.tpl', 42, false),array('modifier', 'text', 'phpgacl/acl_list.tpl', 130, false),array('modifier', 'attr_url', 'phpgacl/acl_list.tpl', 207, false),array('modifier', 'date_format', 'phpgacl/acl_list.tpl', 227, false),array('function', 'html_options', 'phpgacl/acl_list.tpl', 58, false),array('function', 'cycle', 'phpgacl/acl_list.tpl', 128, false),)), $this); ?>
...
<table cellpadding="2" cellspacing="2" border="2" width="100%">
  ...
  <tr valign="middle" align="center">
    ...
    <td><input type="text" name="filter_aco" size="20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['filter_aco'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" class="filter"></td>
    <td><input type="text" name="filter_aro" size="20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['filter_aro'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" class="filter"></td>
    <td><input type="text" name="filter_axo" size="20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['filter_axo'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" class="filter"></td>
  ...
  <tr valign="middle" align="center">
    ...
    <td>&nbsp;</td>
    <td><input type="text" name="filter_aro_group" size="20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['filter_aro_group'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" class="filter"></td>
    <td><input type="text" name="filter_axo_group" size="20" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['filter_axo_group'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" class="filter"></td>
  ...
  <tr valign="middle" align="left">
	...
	<td colspan="5"><input type="text" name="filter_return_value" size="50" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['filter_return_value'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
" class="filter"></td>
  </tr>
...
">
    <td valign="middle" rowspan="3" align="center"><?php echo ((is_array($_tmp=$this->_tpl_vars['acl']['id'])) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
</td>
...
?>
			<li><?php echo ((is_array($_tmp=$this->_tpl_vars['section'])) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
<ol>
...
?>
				<li><?php echo ((is_array($_tmp=$this->_tpl_vars['obj'])) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
</li>
...
?>
			<li><?php echo ((is_array($_tmp=$this->_tpl_vars['group'])) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
</li>
		  <?php endforeach; endif; unset($_from); ?>
		</ol>
	  <?php endif; ?>
...
?>
    ...
    <td valign="middle" rowspan="3" align="center">
        [ <a href="acl_admin.php?action=edit&acl_id=<?php echo ((is_array($_tmp=$this->_tpl_vars['acl']['id'])) ? $this->_run_mod_handler('attr_url', true, $_tmp) : attr_url($_tmp)); ?>
...
">Edit</a> ]
    ...
    <td valign="middle" rowspan="3" align="center">
        <input type="checkbox" class="checkbox" name="delete_acl[]" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['acl']['id'])) ? $this->_run_mod_handler('attr', true, $_tmp) : attr($_tmp)); ?>
">
    </td>
  </tr>
...
">
    ...
    <td valign="middle" colspan="2" align="center">
        <?php echo ((is_array($_tmp=$this->_tpl_vars['acl']['section_name'])) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
...
">
    ...
    <td valign="middle" colspan="2" align="center">
        <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['acl']['updated_date'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d-%b-%Y %H:%M:%S") : smarty_modifier_date_format($_tmp, "%d-%b-%Y %H:%M:%S")))) ? $this->_run_mod_handler('text', true, $_tmp) : text($_tmp)); ?>
