            ...
            <div class="table-responsive">
                <table class='table table-striped text-center'>
                    ...
                    <tr>
                        ...
                        <td><a href="http://44.203.5.156/" class="text-decoration-none" target="_blank"><i class="fa fa-sign-in-alt fa-lg" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="" data-original-title="Login to site HB"></i></a></td>
                    </tr>
                </table>
            </div>
