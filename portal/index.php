...
<head>
    ...
    ?>
    <!-- Hotjar Tracking Code for https://ehr.medbossconsulting.com/portal/?site=serenity -->
    <script>
        (function(h,o,t,j,a,r){
            h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
            h._hjSettings={hjid:3144259,hjsv:6};
...
<body class="login container mt-2">
    <div id="wrapper" class="container-fluid text-center">
        ...
        <br>
        <h1><?php echo xlt("If you are new to the portal, and don't have credentials") ?>  <br>
            <?php echo xlt(" click the RED registration button first.") ?></h1>
    </div><!-- div wrapper -->
    <?php } ?> <!--  logon wrapper -->
